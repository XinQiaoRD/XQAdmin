...
///////////////////////////////////
    ...
    public function imgs(){
        ...
        $cc->For['list'] = $cc->pagei("lead_img",15);
    ...
    public function imgs_add_op(){
        ...
        $cc->opsql("lead_img", 'add');

        if($g->img) $up->moveFile("/uploads/cache/".$g->img , "/uploads/lead/".$g->img);
    ...
    public function imgs_edit_op(){
        ...
        $cc->where = "id=".$id;
        $rs = $cc->opsql("lead_img");

        $up->sqliCache($g->img, "img", "lead", $rs, $cc, "strs");
    ...
    public function imgs_del_op(){
        ...
        $cc->where = "id='{$id}'";
        $rs = $cc->opsql("lead_img");
        $up->delFile("/uploads/lead/", $rs["img"]);

        $cc->where = "id='{$id}'";
        $cc->opsql("lead_img", 'del');
